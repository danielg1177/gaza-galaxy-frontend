...
- 2026-05-29: Task 146 complete — read-only spectator mode when opening async game with `alert_state: 'waiting'`; amber turn banner; End Turn/⋮/fleet drag disabled; map exploration enabled; `waiting` cards tappable on HomeScreen.
